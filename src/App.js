...
function App() {
  ...
  const updateList = (username, age, location, hobby, photo, aboutme) => {
    const listItem = { username, age, location, hobby, photo, aboutme,likes:0};
    changeProfile(
      ...
      <Container className="app">
        <Routes>
          <Route
            ...
            element={
              <Post
                addProfile={(username, age, location, hobby, photo, aboutme) =>
                  updateList(username, age, location, hobby, photo, aboutme)
                }
              />
            }
          />
